<template>
    <div class="min-vh-100 bg-gray-light-app d-flex align-items-center flex-row justify-content-center py-5 mx-3 px-lg-5">
        <div class="bg-white shadow-lg position-relative d-flex flex-column" style="width: 60vw; margin-top: 7vh; height: 92vh">
            <svg class="position-absolute top-0 start-50 translate-middle-x" v-if="user.avatar_url == null" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 166 158" fill="none">
            ...
            <div class="position-absolute top-0 start-50 translate-middle" v-else>
                <div class=" d-flex justify-content-center align-items-center flex-column mt-5">
                    <img style="border-radius: 50%; height: 25%; width: 25%" :src="user.avatar_url">

                    <span class="fs-2 mt-4" v-if="user">
            ...
            <div class="row my-3 w-100 mt-5">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <button class="btn-register-app d-flex align-items-center" @click="setRoute(2)"><hr class="my-4" v-bind:style="styleMyAccount"></button>
                </div>
            </div>
