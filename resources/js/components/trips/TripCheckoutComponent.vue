<template>
    <div class="my-3">
        ...
        <div class="d-flex flex-column justify-content-center w-100 my-3">
            <div class="d-flex w-50 mx-auto bg-white my-3 p-3 rounded-3 shadow-md components_checkout_trip">
                <div class="me-3">
            ...
            <div class="d-flex justify-content-between bg-white w-50 mx-auto my-3 p-3 rounded-3 shadow-md components_checkout_trip">
                <div>
            ...
            <div class="d-flex justify-content-between bg-white w-50 mx-auto my-3 p-3 rounded-3 shadow-md text-green-app components_checkout_trip">
                <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-column bg-white w-50 mx-auto my-3 p-3 rounded-3 shadow-md components_checkout_trip">
            ...
            <div class="d-flex flex-column bg-white w-50 my-3 mx-auto rounded-3 shadow-md components_checkout_trip">
